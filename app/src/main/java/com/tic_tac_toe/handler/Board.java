...
//            sendSprite(currentCell.getBoardSquare());
    ...
    public void initBoard(SpriteBuilder spriteBuilder) {
        this.spriteBuilder = spriteBuilder;

        int des = 200;
        board[0][0] = new Cell(new Coordinate(-des - 55, des - 10), makeSprite(getBoardSquarePath(1, 1)));
        board[0][1] = new Cell(new Coordinate(0, des - 10), makeSprite(getBoardSquarePath(1, 2)));
        board[0][2] = new Cell(new Coordinate(des + 55, des - 10), makeSprite(getBoardSquarePath(1, 3)));
        board[1][0] = new Cell(new Coordinate(-des - 55, 0), makeSprite(getBoardSquarePath(2, 1)));
        board[1][1] = new Cell(new Coordinate(0, 0), makeSprite(getBoardSquarePath(2, 2)));
        board[1][2] = new Cell(new Coordinate(des + 55, 0), makeSprite(getBoardSquarePath(2, 3)));
        board[2][0] = new Cell(new Coordinate(-des - 55, -des), makeSprite(getBoardSquarePath(3, 1)));
        board[2][1] = new Cell(new Coordinate(0, -des), makeSprite(getBoardSquarePath(3, 2)));
        board[2][2] = new Cell(new Coordinate(des + 55, -des), makeSprite(getBoardSquarePath(3, 3)));
